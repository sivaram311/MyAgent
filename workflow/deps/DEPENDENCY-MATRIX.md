...
**Session:** `css-api-migrate-wave-2026-07-15` (css-next consumer wave — Portal/AV/ProdDeck on css-next; trading-portal stays classic)
...
|---------|-------------------|---------|--------|--------------|---------------|-------|
| css | 0.1.0 | `v0.1.0` | `b754f0b` | `H:\releases\css-0.1.0` | https://css.delena.buzz `:5900` | **Classic IdP — keep.** PREPROD `:4900`. Trading-portal F/G still pin here. |
| css-next | **0.2.1** | `v0.2.1` | `75ae5ae` | `H:\releases\css-next-0.2.1` | https://css-next.delena.buzz `:5910` | Side-fleet IdP + minimal Delena `/oauth/login` brand. PREPROD https://css-next-staging.delena.buzz `:4910`. |
...
|--------|-------------------|----------------------|--------------|------------|-------------|-------------|----------|----------------|
| agent-portal | **0.1.9** | `08b0b18` | `H:\releases\agent-portal-0.1.9` | css-next | 0.2.1 | `v0.2.1` | `agent-portal` | nginx `/auth` → `:5910`; issuer `https://css-next.delena.buzz` |
| agentverse-upgrade | **0.3.8** | `4786508` | `H:\releases\agentverse-upgrade-0.3.8` | css-next | 0.2.1 | `v0.2.1` | `agent-portal` (reuse) | F+G **0.3.8** · css-next lockstep with Portal · `agentverse-upgrade[-staging].delena.buzz` |
...
| trading-portal | **0.1.0** | `v0.1.0` + tip `cf5176d` | `H:\releases\trading-portal-0.1.0` | css | 0.1.0 | `v0.1.0` | `trading-portal` | PROD JWKS classic `:5900`; F classic `:4900`; pushed `sivaram311/trading-portal` |

### PREPROD notes

PREPROD: ProdDeck F (`:4320`) **0.8.4** css-next hybrid.  
**agentverse-upgrade** F (`:4312`) and G (`:5312`) both **0.3.8** css-next.  
**agent-portal** F (`:4080`) **0.1.9** css-next.  
**trading-portal** F (`:4340`/`:4341`) **0.1.0** classic JWKS `:4900` (unchanged by this wave).
