...
| agent-portal | Agent Portal (+ AgentVerse reuse) | active | Portal Live **0.1.10** hybrid OAuth/PKCE on css-next; AV-upgrade **0.3.8** reuses clientId |
...
| trading-portal | trading-portal | active | E:\MyWorkspace\trading-portal · F/G:\apps\trading-portal | Live **0.1.0** tip `5ea7334` (repo sivaram311/trading-portal); F JWKS css-next `:4910`; G JWKS css-next `:5910` / issuer https://css-next.delena.buzz; paper-only |
